...
/**
 * Embedded demo board blueprint (formerly demo-board.json)
...
const demoBoard = {
  ...
  nodes: [ /* --- NODES --- */ 
    ...
    },
    {
      ...
      data: {
        ...
        imageUrl: "https://thumbs.dreamstime.com/b/sri-lanka-mass-protest-movement-colombo-th-july-thousands-people-unite-near-beira-lake-estuary-presidential-secretary-hq-253149364.jpg",
    ...
    },
    {
      ...
      data: {
        ...
        linkUrl: "https://www.reuters.com/world/asia-pacific/crisis-hit-sri-lanka-shuts-schools-urges-work-home-save-fuel-2022-06-27/",
    ...
    },
    {
      ...
      data: {
        ...
        linkUrl: "https://www.theguardian.com/world/2022/jul/09/sri-lanka-protests-thousands-storm-presidents-residence-colombo",
    ...
    },
    {
      ...
      data: {
        ...
        linkUrl: "https://www.aljazeera.com/news/2022/7/13/timeline-sri-lankas-worst-economic-political-crisis-in-decades",
  ...
  edges: [
    ...
    { id: "e-6f72b5", sourceId: "n-mar31-mirihana", targetId: "n-apr3-cabinet" },
    { id: "e-de80d0", sourceId: "n-apr3-cabinet", targetId: "n-apr9-gotagogama" },
    { id: "e-7c6d49", sourceId: "n-apr9-gotagogama", targetId: "n-apr19-rambukkana" },
    { id: "e-b22254", sourceId: "n-apr19-rambukkana", targetId: "n-may9-violence-pm-resigns" },
    { id: "e-60a975", sourceId: "n-may9-violence-pm-resigns", targetId: "n-jun27-fuel-halt" },
    { id: "e-cec486", sourceId: "n-jun27-fuel-halt", targetId: "n-jul9-storm-residence" },
    { id: "e-e4b9dd", sourceId: "n-jul9-storm-residence", targetId: "n-jul13-flee" },
    { id: "e-5d2322", sourceId: "n-jul13-flee", targetId: "n-jul14-resign" },
    { id: "e-87c4f4", sourceId: "n-jul14-resign", targetId: "n-jul20-ranil-elected" },
    { id: "e-cb9099", sourceId: "n-jul20-ranil-elected", targetId: "n-jul22-camp-raid" }
  ]
};
...
async function seedDemoBoard() {
  const existing = await prisma.board.findUnique({ where: { id: demoBoard.id } });
  if (existing) {
